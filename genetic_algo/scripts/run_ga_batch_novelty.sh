    ...
    for ALGO in "${ALGOS[@]}"; do
        ...
        for SEED in ${SEEDS}; do
            ...
            python train_ga.py \
                ...
                --population_size 64 --generations 50 --num_workers 4 --max_steps 2000 \
                --novelty --novelty-method nearest_neighbors --novelty-weight 0.25 --novelty-neighbors 5 \
                --crossover_rate 0 --mutation_sigma 0.1 --mutation_sigma_variance 1.5 \
                "${EXTRA_ARGS[@]}"
        done
    done
done
